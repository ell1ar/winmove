...
import { ref } from "vue";
const isShowModalRegister = defineModel();
...
<template>
    <VueFinalModal v-model="isShowModalRegister" swipe-to-close="down" :overlay-transition="options.overlayTransition" :content-transition="options.contentTransition">
        <div
            ...
            <div class="flex h-full w-full flex-col xl:ml-auto xl:w-[372px]">
                <template v-if="[0, 1].includes(slectedTab)">
                    <div class="mb-[20px] flex justify-end xl:hidden">
                        <button @click="isShowModalRegister = false">
