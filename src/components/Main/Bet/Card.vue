...
<template>
    <div class="rounded-[20px] flex flex-col items-center grow h-[177px] p-[15px] border-[1px] border-[#222325]">
        <div class="grid grid-cols-3 w-full place-content-center">
            <div class="h-[60px] flex items-center justify-between">
                <p class="text-[13px] text-[#ACACAC]">Natus Vincere</p>
            </div>

            <div class="flex flex-col items-center">
                <h2 class="text-[#BCBCBC] text-[14px]">21:03 MSK</h2>
                <p class="text-[#4C4D4F] text-[12px]">30 июня 2024</p>
                <strong class="text-[22px] text-[#1E1E1E]">VS</strong>
            </div>

            <div class="h-[60px] flex items-center justify-between">
                <p class="text-[13px] text-[#ACACAC]">G2</p>
            </div>
        </div>

        <p class="text-[12px] text-[#4C4D4F] mt-auto mb-2.5">PGL CS2 Major Copenhagen 2024</p>
