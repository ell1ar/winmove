<template>
    <div class="flex grow flex-col gap-[5px] p-0 lg:rounded-[20px] lg:bg-[#101113] lg:p-5">
        <PagesMainTableRowWrapper class="h-[45px]">
        ...
        </PagesMainTableRowWrapper>

        <template v-for="i in 2">
            <PagesMainTableRowWrapper class="h-[56px]" v-for="i in 5" :key="i">
                <div class="flex w-[40%] items-center justify-start gap-2.5 pl-[15px] sm:w-[40%] lg:pl-[30px]">
                    <ModulesPlayerAvatarIndex :color="['blue', 'orange', 'purple', 'white', 'yellow'][i - 1]" />
                    <ModulesPlayerNameIndex class="text-[10px] sm:text-[15px]" :color="['blue', 'orange', 'purple', 'white', 'yellow'][i - 1]" />
                </div>
